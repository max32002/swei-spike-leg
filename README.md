# 獅尾尖腿黑體 Swei Spike Sans

獅尾尖腿黑體基於[思源黑體](https://github.com/adobe-fonts/source-han-sans)的轉角長尖刺改造，更加簡明現代化的字體。支援简体中文、繁體中文、韓文與日文；可以免費商用，歡迎大家自由應用、自由優化、自由改作！

獅尾尖腿黑體的特色是，「口」字的4個轉角長尖刺。

「獅尾尖腿黑體」與「獅尾尖刺黑體」差別在有沒有拔腳，「拔腳」就是會有較少的筆畫，例如移除「口」字的左右下角會多出的短線條。有拔腳的字會較圓，但是會造成有些字因直接去掉腿後左右不平衡、左右不對襯的「懸空」問題。改使用「腿」系列字體就不會有這個問題。

![字體預覽](https://github.com/max32002/swei-spike-leg/raw/master/preview/welcome.png)

和思源黑體一樣，支援7種的字重：
![字重比較](https://github.com/max32002/swei-spike-leg/raw/master/preview/compare_style.png)
...
### 「CJK TC」和「CJK SC」的比較：
![TC和SC比較](https://github.com/max32002/swei-spike-leg/raw/master/preview/compare_tc_sc.png)
...
### 「CJK TC」和「CJK JP」的比較：
![TC和SC比較](https://github.com/max32002/swei-spike-leg/raw/master/preview/compare_tc_jp.png)
...
## 更新日誌
[點擊此處](https://github.com/max32002/swei-spike-leg/blob/master/change_log.md) 查看更新記錄。
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/swei-spike-leg@2.0/WebFont/CJK%20TC/SweiSpikeLegCJKtc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/swei-spike-leg@2.0/WebFont/CJK%20TC/SweiSpikeLegCJKtc-Regular.woff) format("woff");
}
```
